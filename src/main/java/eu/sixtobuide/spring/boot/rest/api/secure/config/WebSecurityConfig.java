...
import eu.sixtobuide.spring.boot.rest.api.secure.security.auth.RestAuthenticationEntryPoint;
import eu.sixtobuide.spring.boot.rest.api.secure.security.auth.TokenAuthenticationFilter;
